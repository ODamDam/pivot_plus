...
|---|---:|---|
| lexical | 1 | sufficient_or_review |
| syntactic | 1 | sufficient_or_review |
| semantic_paraphrase | 0 | new_needed |
| encoding | 1 | sufficient_or_review |
| structural | 8 | sufficient_or_review |
| contextual | 3 | sufficient_or_review |
| noise_injection | 2 | sufficient_or_review |
